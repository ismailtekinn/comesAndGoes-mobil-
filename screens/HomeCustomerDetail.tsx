...
const HomeCustomerDetail = () => {
  ...
  const { customerId, customerName, customerSurname, customerPhone } =
    route.params as {
      customerId: number;
      customerName: string;
...
const customerInfo: IPdfCustomerInfo = {
  clientName: customerName,
  clientSurname: customerSurname,
  clientPhone: customerPhone,
  TotalCash: filteredCash?.[0]?.totalCash ?? 0,
  TotalDebt: filteredCash?.[0]?.totalDebt ?? 0,
};
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          onPress={() => {
            createAndSharePDF(filteredCustomers, customerInfo,t);
          }}
        >
          <Ionicons
              ...
              <View style={styles.operationItem}>
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        customer.transactionType === "cash" ? "green" : "red",
                    },
                  ]}
                >
...
const styles = StyleSheet.create({
  ...
  iconsContainer: {
    flexDirection: "row",
    marginLeft: "auto", // Burada ikon grubunu sağa iter
  },
  icon: {
    marginLeft: 10,
