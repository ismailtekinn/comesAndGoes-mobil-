    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.operationsList}>
        {filteredCustomers.map((customer: Customer, index) => {
          ...
          // Tarihi formatla
          const isHijri = format === "12"; // format kontrolü
          const formattedDate = customer.debtIssuanceDate
            ? isHijri
              ? // Hicri formatında tarih dönüşümü
                moment(customer.debtIssuanceDate).format(
                  "iYYYY-iMM-iDD hh:mm A"
                )
              : // Miladi formatında tarih dönüşümü
            ...
            >
              <View style={styles.operationItem}>
                ...
                <View style={styles.operationInfo}>
                  <Text style={styles.operationDate}>{formattedDate}</Text>
