...
//                 {t.cashReceivablePage.customerName}
//               </Text>
//               <Picker
//                 selectedValue={
...
//             <View style={styles.formControl}>
//               <Text style={styles.label}>
//                 {t.cashReceivablePage.customerPhone}
//               </Text>
//               <TextInput
//                 style={styles.input}
...
//             <View style={styles.formControl}>
//               <Text style={styles.label}>
//                 {t.cashReceivablePage.debtLendingDate}
//               </Text>
//               <TextInput
//                 style={styles.input}
...
//             <View style={styles.formControl}>
//               <Text style={styles.label}>
//                 {t.cashReceivablePage.debtRepaymentDate}
//               </Text>
//               <TextInput
//                 style={styles.input}
//                 placeholder="YYYY-MM-DD"
...
//               <Button
//                 title={t.cashReceivablePage.borrowMoney}
